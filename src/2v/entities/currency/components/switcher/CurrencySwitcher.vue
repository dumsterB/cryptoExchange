...
import CurrencyIcon from '../icon/CurrencyIcon.vue';
...
import { useClickOutside } from '@/2v/shared/hooks/useClickOutside';
import { currencies, useCurrencyStore } from '@/2v/entities/currency/store/currency';
